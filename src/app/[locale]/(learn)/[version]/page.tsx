...
export default async function VersionPage({
  ...
  const meta = getVersionMeta(version, locale);
          ...
          >
            ...
            <div>
              ...
              <div className="font-medium">
                {prevVersion} - {tSession(prevVersion) || getVersionMeta(prevVersion, locale)?.title}
              </div>
            </div>
          </Link>
        ) : (
        ...
        {nextVersion ? (
          ...
          >
            <div>
              ...
              <div className="font-medium">
                {tSession(nextVersion) || getVersionMeta(nextVersion, locale)?.title} - {nextVersion}
              </div>
            </div>
            <span className="transition-transform group-hover:translate-x-1">
              &rarr;
